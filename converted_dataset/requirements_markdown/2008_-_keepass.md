...
- Source file: `2008 - keepass.xml`
- Version: 1.10
- Issue date: 2008-02-17
- File number: 0
...
REQ-2008_-_KEEPASS-1: REQ-1: KeePass must be downloaded and installed

## Requirement 2

REQ-2008_-_KEEPASS-2: REQ-2: Master Password has no limits in length. A whole sentence can be used with more than 100 characters.
...
REQ-2008_-_KEEPASS-3: Folder selected must be of type the database can read and that is “name”.kdb
...
REQ-2008_-_KEEPASS-4: Databases must have different names or else the previews one will be replace if selected
...
REQ-2008_-_KEEPASS-5: There must be entries in the database in order for them to be printed
...
REQ-2008_-_KEEPASS-6: All data related to the word must be shown. For example if user types “abc” and abc is part of a password and of a username, both entries must be shown
...
REQ-2008_-_KEEPASS-7: A name is required in order for the new group/subgroup to be created

## Requirement 8

REQ-2008_-_KEEPASS-8: A subgroup cannot be created when no group is selected
...
REQ-2008_-_KEEPASS-9: A name is required in order for the group/subgroup to be renamed
...
REQ-2008_-_KEEPASS-10: In order to find something in a group a word must be placed in the find field
...
REQ-2008_-_KEEPASS-11: An entry must belong to a group to be created

## Requirement 12

REQ-2008_-_KEEPASS-12: When the password field is completed the repeat password field must be completed

## Requirement 13

REQ-2008_-_KEEPASS-13: REQ-13: Password field and repeat password field must be identical
...
REQ-2008_-_KEEPASS-14: ìAn entry must be selected to be viewed or modified

## Requirement 15

REQ-2008_-_KEEPASS-15: ìWhen the password field is changed the repeat password field must be Changed and be identical with password field
...
REQ-2008_-_KEEPASS-16: An entry must be selected before it is duplicated
...
REQ-2008_-_KEEPASS-18: REQ-18: An internet connection and a browser are required in order to download new language translations For the following features, use cases are not included
...
REQ-2008_-_KEEPASS-19: The prefix “Auto-Type:” is required in front of each sequence

## Requirement 20

REQ-2008_-_KEEPASS-20: Sequence’s length must not be more than a line (59 characters)

## Requirement 21

REQ-2008_-_KEEPASS-21: If two auto-types are referred in one note field, only the first is used
...
REQ-2008_-_KEEPASS-22: Only one database file is allowed in command line options

## Requirement 23

REQ-2008_-_KEEPASS-23: In case a space is found in the path, it must be enclosed into quotes
...
REQ-2008_-_KEEPASS-24: If a master password is required to unlock the database, the database doesn’t open unless the password is entered

## Requirement 25

REQ-2008_-_KEEPASS-25: If a key file is required to unlock the database, the database doesn’t open unless the key file is present

## Requirement 26

REQ-2008_-_KEEPASS-26: If there is a composite key, both master password and key file are required

## Requirement 27

REQ-2008_-_KEEPASS-27: In case of lost master password or key file, the database never unlocks again. There is no recovery

## Requirement 28

REQ-2008_-_KEEPASS-28: There is no backdoor or key that unlocks all databases
...
REQ-2008_-_KEEPASS-29: REQ-29: File formats are not specialized password database formats

## Requirement 30

REQ-2008_-_KEEPASS-30: REQ-30: File formats only specify a low-level layout of stored data
...
REQ-2008_-_KEEPASS-31: Global hot key cannot be changed
...
REQ-2008_-_KEEPASS-32: Title, username or URL cannot be changed in a TAN entry.

## Requirement 33

REQ-2008_-_KEEPASS-33: When a TAN is used, it expires automatically and can never be used again.
