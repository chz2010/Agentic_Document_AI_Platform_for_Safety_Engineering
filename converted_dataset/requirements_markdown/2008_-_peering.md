...
REQ-2008_-_PEERING-1: The format for service information description is defined
...
REQ-2008_-_PEERING-2: The interaction protocol between Web Server-SR, SR-mediator is defined.

## Requirement 3

REQ-2008_-_PEERING-3: Resource provisioning, delegation and reservation policies are in place

## Requirement 4

REQ-2008_-_PEERING-4: There is an established norm that any resource failure will be reported

## Requirement 5

REQ-2008_-_PEERING-5: The interaction protocol between Web Server-SR, SR-mediator is defined.
...
REQ-2008_-_PEERING-1: Malicious requests are detected and rejected.

## Requirement 2

REQ-2008_-_PEERING-2: Web servers have already replicated necessary content.

## Requirement 3

REQ-2008_-_PEERING-3: Both anticipated and unanticipated user requests (traffic) are considered.

## Requirement 4

REQ-2008_-_PEERING-4: The format for service information description is defined
...
REQ-2008_-_PEERING-1: The format of service requirements is defined.

## Requirement 2

REQ-2008_-_PEERING-2: Mediator-SR, mediator-PR, mediator-PA interaction protocols are defined.

## Requirement 3

REQ-2008_-_PEERING-3: Mediator works in conjunction with the PA to establish negotiation.
...
REQ-2008_-_PEERING-1: Interaction protocols between PAs are identified.

## Requirement 2

REQ-2008_-_PEERING-2: Malicious requests are identified and acted upon.

## Requirement 3

REQ-2008_-_PEERING-3: There are existing policies for long-term peering arrangement.

## Requirement 4

REQ-2008_-_PEERING-4: There is procedure to perform short-term negotiation.
...
REQ-2008_-_PEERING-1: Negotiation is established between selected CDN peers.

## Requirement 2

REQ-2008_-_PEERING-2: Primary CDN has already acquired sufficient external resources.

## Requirement 3

REQ-2008_-_PEERING-3: Functional policies are identified and deployed.

## Requirement 4

REQ-2008_-_PEERING-4: Effective content delivery is ensured through SLA satisfaction.
...
REQ-2008_-_PEERING-1: Policies identifying the consequences of SLA violation are defined.

## Requirement 2

REQ-2008_-_PEERING-2: Policies are in place to perform renegotiation for problem resolution.

## Requirement 3

REQ-2008_-_PEERING-3: Policies are in place to perform renegotiation for problem resolution.
